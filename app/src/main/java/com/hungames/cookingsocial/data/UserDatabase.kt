    ...
    class Callback @Inject constructor(private val database: Provider<UserDatabase>, @ApplicationScope private val applicationScope: CoroutineScope) : RoomDatabase.Callback() {
        ...
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            applicationScope.launch {
                ...
                val tim = RegisteredUser(password = passwordHash, email = "tim.lemon@geng.org", street = "Schemkesweg 42", postal = "47057", city = "Duisburg", country = "Germany", userDescription = "Professional LoL player also passionate cooker.")
                val martin = RegisteredUser(password = passwordHash, email = "martin.larsson@g2.org", street = "Grabenstraße 120", postal = "47057", city = "Duisburg", country = "Germany", userDescription = "One of the best ADC in the west offering culinaries from Sweden.")
                val tina = RegisteredUser(password = passwordHash, email = "tina.nemesis@geng.org", street = "Oststraße 48", postal = "47057", city = "Duisburg", country = "Germany", userDescription = "The girlfriend of Tim Lemon who offers dishes inspired by various culture.")


                userDao.insertUser(RegisteredUser(password = passwordHash, email = "viet.hungdinh@yahoo.de"))
